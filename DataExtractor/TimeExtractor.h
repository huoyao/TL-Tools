...
protected:
  ...
  void Out2FileInt(const std::vector<std::string> &prefix_double, const std::vector<int> res_t[], const int &i);
  void Out2FileDouble(const std::vector<std::string> &prefix_double, const std::vector<double> res_t[], const int &i);
...
private:
  ...
  std::unordered_map<std::string, int> str_map_double;
  std::unordered_map<std::string, int> str_map_int;
